  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-6">
      <div className="flex justify-between items-center bg-gray-800 p-6 rounded-xl border border-gray-700 shadow-xl">
        ...
        <Link to="/products" className="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-sm transition">
          ...
          {loading ? (
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-700 text-gray-200 text-sm">
                {categories.map((cat) => (
                  <tr key={cat.id} className="hover:bg-gray-700/40 transition">
