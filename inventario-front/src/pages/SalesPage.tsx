          ...
          <tbody className="divide-y divide-slate-700/50 text-sm">
            {loading ? (
              ...
              sales.map((sale: any) => {
                ...
                return (
                  <tr key={sale.id} className="hover:bg-slate-700/40 transition">
                    ...
                    <td className="p-4">
                      <span className={`px-2.5 py-1 rounded-md text-xs font-semibold ${
                        sale.status === 'COMPLETED' ? 'bg-emerald-900/70 text-emerald-300 border border-emerald-700' :
                    ...
                    <td className="p-4 text-xs">
                      {items.length > 0 ? (
                        ...
                        <span className="text-slate-500 italic">Sin ítems</span>
                      )}
                    </td>
                  </tr>
                );
