    ...
    <div className="p-8 max-w-7xl mx-auto text-white">
      ...
      <div className="bg-gray-800 rounded-lg shadow-md overflow-x-auto">
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {loading ? (
              <tr><td colSpan={5} className="p-4 text-center text-gray-400">Cargando clientes...</td></tr>
            ) : customers.length > 0 ? (
              ...
              <tr><td colSpan={5} className="p-4 text-center text-gray-500 italic">No hay clientes registrados.</td></tr>
            )}
          </tbody>
        </table>
      </div>
